 ...
 export const Services: ServiceProps[] = [
    { name: 'Store', status: 'Coming soon...', logo: '🛍️', href: '#services', target: '', text: 'Spend It Like Royalty' },
    ...
    { name: 'Travel', status: 'Coming soon...', logo: '✈️', href: '#services', target: '', text: 'Visit Nigeria – Where Every Journey Tells a Story' },
